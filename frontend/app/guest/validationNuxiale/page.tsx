...
interface CeremonyResponse {
  Night: "attending" | "not-attending" | ""
}

export default function GuestValidation() {
  const [guestName, setGuestName] = useState("")
  const [responses, setResponses] = useState<CeremonyResponse>({ Night: ""})
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch(`http://localhost:5000/api/guests/${guestId}/responses`, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
        },
        body: JSON.stringify({
          NightResponse: responses.Night,
        }),
      });
              ...
              <CardContent className="space-y-6">
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-charcoal-700"> 12h00</span>
                    </div>
                    <div className="flex items-center space-x-2">
                ...
                <div className="space-y-3">
                  ...
                  <RadioGroup
                    ...
                    onValueChange={(value) =>
                      setResponses({ ...responses, Night: value as "attending" | "not-attending" })
                    }
                  ...
                  {responses.Night && (
                    <Badge
                      className={
                        responses.Night === "attending" ? "bg-sage-100 text-sage-800" : "bg-cream-100 text-charcoal-800"
                      }
                    >
                      {responses.Night === "attending" ? "Présent" : "Absent"}
                    </Badge>
                  )}
                </div>
              </CardContent>
            ...
            <div className="flex justify-center space-x-4">
              {!isSubmitted ? (
                ...
                <Button
                  ...
                  disabled={!responses.Night || isLoading}
                >
